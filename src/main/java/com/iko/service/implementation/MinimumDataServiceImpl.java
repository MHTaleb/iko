    ...
    public void setupMovies() {
        ...
        try {
            ...
            movie.setDetail("The Dark Knight Rises, ou L'Ascension du Chevalier Noir au Québec et au Nouveau-Brunswick,\n"
                    ...
                    + " c'est le dernier volet de la trilogie comprenant Batman Begins (2005) et The Dark Knight : Le Chevalier noir (2008).");
            mjc.create(movie);
            //3em film
            movie = new Movie();
            movie.setNotes(new ArrayList<>());
            ...
            movie.setDetail("Venom est un film de super-héros américain réalisé par Ruben Fleischer, sorti en 2018.\n"
                    + " Il s'agit de l’adaptation cinématographique du personnage Venom, ennemi de Spider-Man, publié par Marvel Comics.");
            mjc.create(movie);
            ...
            movie.setDetail("Green Book : Sur les routes du sud  est un film américain réalisé par Peter Farrelly, sorti en 2018. \n" + "Il s'agit d'un film biographique sur le chanteur Don Shirley et Tony Lip.\n"
            ...
            movie.setType(MovieType.COMEDY);
            movie.setDetail("Maman, j'ai raté l'avion (Home Alone) est une comédie familiale américaine réalisée par Chris Columbus, sortie en 1990.");
            mjc.create(movie);
            ...
            movie.setDetail("Beca, une étudiante de première année à la Barden University,"
                    ...
                    + "En injectant une énergie indispensable dans leur répertoire, les Bellas affrontent leurs rivaux masculins dans une compétition sur le campus.\n"
            ...
            movie.setTitle("ROOM");
            movie.setType(MovieType.ROMANCE);
            movie.setDetail("Room est un film dramatique canado-irlandais-britannique-américain réalisé par Lenny Abrahamson, sorti en 2015.\n" + "Les deux acteurs principaux sont Brie Larson, jouant la mère du petit garçon de 5 ans, Jack, qui est lui joué par Jacob Tremblay.");
            mjc.create(movie);
            ...
            movie.setDetail("Titre québécois	La Religieuse\n"
                    ...
                    + "Acteurs principaux :" + "Taissa Farmiga ," + "Demi?n Bichir ," + "Jonas Bloquet ," + "Charlotte Hope ," + "Ingrid Bisu ," + "Bonnie Aarons\n"
                    + "Pays d’origine	Etats-Unis\n"
                    + "Genre	horreur\n"
                    + "Durée	96 minutes\n"
                    + "Sortie	2018");
            ...
            movie.setDetail("Saw ou Décadence au Québec est un film d'horreur (thriller horrifique) américano-australien réalisé par James Wan, sorti en 2004." + "C'est le premier volet de la série de films Saw."
                    + "Il est écrit par Leigh Whannell et James Wan, qui se sont inspirés de deux autres thrillers : Cube et Seven.");
            mjc.create(movie);
            ...
            movie.setType(MovieType.HOROR);
            movie.setDetail("Scream (en français : « Hurlement ») ou Frissons au Québec, est un film d'horreur américain réalisé par Wes Craven, sorti en 1996." + "Il est le premier film de la tétralogie qui est constituée de Scream 2, Scream 3 et Scream 4. " + "La franchise connaît ensuite une série télévisée, dont la saison 1 est diffusée dès juin 2015 sur MTV. "
